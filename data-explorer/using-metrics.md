...
| 연결 유지 | 개수 | Avg | 클러스터의 응답성을 추적 합니다. <br> <br> 완전히 응답성이 높은 클러스터는 값 1을 반환 하 고 차단 되거나 연결이 끊어진 클러스터는 0을 반환 합니다. |
...
연속 내보내기 최대 지연 |    개수   | 최대값   | 클러스터의 연속 내보내기 작업에서 보고 한 지연 (분)입니다. | 없음 |
...
사용률 내보내기 |    백분율 | 최대값   | 클러스터의 총 내보내기 용량 (0에서 100 사이)에서 사용 되는 내보내기 용량입니다. | 없음 |
