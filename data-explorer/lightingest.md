...
1. 위치 표시줄에서 기존 위치 정보를 삭제 합니다.
    ...
    :::image type="content" source="media/lightingest/lightingest-locationbar.png" alt-text="Azure 데이터 탐색기에서 LightIngest에 대 한 기존 위치 정보 삭제":::
