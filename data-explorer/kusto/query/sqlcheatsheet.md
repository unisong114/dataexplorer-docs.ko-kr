...
Kusto와 상호 작용 하는 주 언어가 KQL (Kusto 쿼리 언어)로 전환 되 고 전환 및 학습 환경을 용이 하 게 하기 위해 Kusto 서비스를 사용 하 여 SQL 쿼리를 KQL로 변환할 수 있습니다. 이는 ' 설명 ' 동사를 접두사로 사용 하 여 SQL 쿼리를 Kusto 서비스로 전송 하 여 달성할 수 있습니다.
...
다음 표에서는 SQL 및 해당 KQL equivalients의 샘플 쿼리를 보여 줍니다.
