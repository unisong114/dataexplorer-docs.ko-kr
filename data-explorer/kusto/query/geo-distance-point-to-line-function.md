...
:::image type="content" source="images/geo-distance-point-to-line-function/us-south-coast-storm-events.png" alt-text="북쪽 Las Vegas 공항 및도로 간의 거리":::
...
Taxi pickups. Pickups은 정의 된 여러 줄에서 최대 0.1 미터 까지의 최대 거리를 기준으로 필터링 됩니다.

:::image type="content" source="images/geo-distance-point-to-line-function/madison-ave-road.png" alt-text="북쪽 Las Vegas 공항 및도로 간의 거리":::
