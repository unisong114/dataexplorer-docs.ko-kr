...
|`E_LOW_MEMORY_CONDITION`           | `7`  |`0x80DA0007`|사용 가능한 프로세스 메모리가 부족 하 여 작업이 중단 되었습니다.                                              |
|`E_WRONG_NUMBER_OF_FIELDS`         | `8`  |`0x80DA0008`|수집을 위해 전송 된 csv 문서에 잘못 된 수의 필드 (다른 레코드와 비교)가 있는 레코드가 있습니다.|
