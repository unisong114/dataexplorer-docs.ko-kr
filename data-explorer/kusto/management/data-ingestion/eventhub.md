...
* 이벤트 페이로드는 [Azure 데이터 탐색기에서 지 원하는 형식](../../../ingestion-supported-formats.md)중 하나로 수집 되는 하나 이상의 레코드를 포함할 수 있습니다.
...
| 태그 (미리 보기) | JSON 배열 문자열로 형식이 지정 된 수집 데이터와 연결할 [태그](../extents-overview.md#extent-tagging) 의 목록입니다. 태그를 사용 하는 경우 [성능에 영향을 미칩니다](../extents-overview.md#performance-notes-1) . |
...
## <a name="create-event-hub-connection"></a>이벤트 허브 연결 만들기
...
* Via Azure Portal: [이벤트 허브에 연결](../../../ingest-data-event-hub.md#connect-to-the-event-hub)합니다.
...
* ARM 템플릿 사용: [이벤트 허브 데이터 연결을 추가 하기 위해 Azure Resource Manager 템플릿](../../../data-connection-event-hub-resource-manager.md#azure-resource-manager-template-for-adding-an-event-hub-data-connection) 사용
