...
[**mv-expand**](kusto/query/mvexpandoperator.md): 다중 값 컬렉션을 동적 형식 열에서 확장하여 컬렉션의 각 값이 별도의 행을 얻습니다. 확장된 행의 다른 열은 모두 중복됩니다. 즉, 이 연산자는 makelist의 반대 개념이라 할 수 있습니다.
